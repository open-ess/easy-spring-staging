...
@Slf4j
public class AccountInfoController implements SimpleRest {
  ...
  public RestResult<Page<AccountInfo>> queryPage(@SwaggerParam Query q, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    q.sort(getColumnMap());
    return RestResult.success(accountInfoService.queryPage(u, q));
  }
  ...
  public RestResult<AccountInfo> queryDetails(@PathVariable(value = "id") String id, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    return RestResult.success(accountInfoService.queryDetails(u, id));
  }
  ...
  public RestResult<String> add(@RequestBody AccountInfo accountInfo, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    return RestResult.success(accountInfoService.add(u, accountInfo));
  }
  ...
  public RestResult<Boolean> editAll(@PathVariable(value = "id") String id, @RequestBody AccountInfo accountInfo, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    return RestResult.success(accountInfoService.editAll(u, id, accountInfo));
  }
  ...
  public RestResult<Boolean> edit(@PathVariable(value = "id") String id, @RequestBody AccountInfo accountInfo, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    return RestResult.success(accountInfoService.edit(u, id, accountInfo));
  }
  ...
  public RestResult<Boolean> remove(@PathVariable(value = "id") String id, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    return RestResult.success(accountInfoService.remove(u, id));
  }
  ...
  public RestResult<Integer> removeMulti(@RequestParam(value = "ids") List<String> ids, @UserParam AuthorizationUser<?, ?, ?, ?> u) throws Exception {
    return RestResult.success(accountInfoService.removeMulti(u, ids));
  }
