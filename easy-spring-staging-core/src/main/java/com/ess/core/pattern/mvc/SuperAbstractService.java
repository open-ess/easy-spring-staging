 ...
 */
public abstract class SuperAbstractService<K, M extends Model<K>> {
  /**
   * @param p           分页模型
   ...
   */
  @SuppressWarnings("unchecked")
  protected void queryPageExecute(AuthorizationUser<?, ?, ?, ?> u, Class<? extends QueryPageExecutor> clazz, QueryParameter q, Page<M> p, QueryPageExecutor<K, M>... executors) throws Exception {
    if (executors != null) {
