...
package com.ess.core.repository;
...
public interface BaseDao<K, M extends Model<K>> {
  ...
  Page<M> QueryNativePage(AuthorizationUser<?, ?, ?, ?> u, Query q) throws Exception;
   ...
   */
  List<M> query(@Param(value = "u") AuthorizationUser<?, ?, ?, ?> u, @Param(value = "q") Query q) throws Exception;
   ...
   * @date 2021/9/4 9:18
   */
  Long count(@Param(value = "u") AuthorizationUser<?, ?, ?, ?> u, @Param(value = "q") Query q) throws Exception;
